      ...
      <div className="relative min-h-screen w-full">
        ...
        <div className="relative z-50 flex flex-col items-center justify-center min-h-screen w-full px-4">
          <div className="text-center">
            <h1 className="text-6xl font-bold text-white mb-6 font-medium">
              Study Share 
            </h1>
            <p className="text-xl text-neutral-400 mb-8 max-w-2xl">
              An online repository for college notes contributed by students
            </p>
            <div className="flex gap-4 justify-center">
              <button href="/" className="px-8 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">
                Register Now
              </button>
